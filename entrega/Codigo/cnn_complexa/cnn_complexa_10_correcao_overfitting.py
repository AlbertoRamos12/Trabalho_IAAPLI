...
parser = argparse.ArgumentParser(description="Treinamento de uma CNN complexa no CIFAR-10 com correção de overfitting.")
...
model_filename = f"complex_cnn_10_correcao_overfitting_e{num_epochs}.pth"
...
def plot_training_metrics(train_losses, train_accuracies, val_losses, val_accuracies, graphics_dir):
    ...
    graph_filename = f"complex_cnn_training_metrics_10_correcao_overfitting_e{num_epochs}.png"
