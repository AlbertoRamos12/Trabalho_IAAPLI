...
plt.ylabel("Accuracy")
plt.title(f"Comparação de Accuracy dos Classificadores (CIFAR-100)\n{pca_info}")
...
if args.pca_components is not None:
    output_file = os.path.join(graphics_dir, f"cnn_simples_cifar100_classifiers_comparison_pca{n_pca}.png")
else:
    output_file = os.path.join(graphics_dir, "cnn_simples_cifar100_classifiers_comparison_sem_pca.png")
