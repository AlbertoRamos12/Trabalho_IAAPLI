...
parser = argparse.ArgumentParser(description="Treinamento de uma CNN complexa no CIFAR-100 com correção de overfitting.")
...
val_dataset = CustomCIFARDataset(val_images, val_labels, transform=val_test_transform)
test_dataset = CustomCIFARDataset(test_images, test_labels, transform=val_test_transform)
...
# ----------------------------
# DEFINIÇÃO DE UMA CNN MAIS COMPLEXA COM CORREÇÃO DE OVERFITTING
# ----------------------------
...
optimizer = optim.Adam(model.parameters(), lr=0.001, weight_decay=7.5e-4)
...
model_filename = f"complex_cnn_100_correcao_overfitting_e{num_epochs}.pth"
...
def plot_training_metrics(train_losses, train_accuracies, val_losses, val_accuracies, graphics_dir):
    ...
    graph_filename = f"complex_cnn_training_metrics_100_correcao_overfitting_e{num_epochs}.png"
