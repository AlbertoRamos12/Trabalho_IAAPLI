...
# Carregar os batches de treino do CIFAR-10
...
output_train = os.path.join(deepfeatures_dir, "cifar10_deepfeatures_train.pkl")
...
output_test = os.path.join(deepfeatures_dir, "cifar10_deepfeatures_test.pkl")
