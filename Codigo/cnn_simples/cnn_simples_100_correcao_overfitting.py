...
from PIL import Image  # Adicionado para data augmentation
...
class CustomCIFARDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img_rgb = Image.fromarray(img_rgb)  # Converte para PIL.Image
...
for epoch in range(num_epochs):
    ...
    for inputs, targets in train_loader:
        inputs, targets = inputs.to(device), targets.to(device)  # corrigido
...
model_filename = f"simple_cnn_100_correcao_overfitting_e{num_epochs}.pth"
...
def plot_training_metrics(train_losses, train_accuracies, val_losses, val_accuracies, graphics_dir):
    ...
    graph_filename = f"simple_cnn_training_metrics_100_correcao_overfitting_e{num_epochs}.png"
