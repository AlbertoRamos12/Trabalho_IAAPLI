...
model_filename = f"simple_cnn_10_correcao_overfitting_e{num_epochs}.pth"
...
def plot_training_metrics(train_losses, train_accuracies, val_losses, val_accuracies, graphics_dir):
    ...
    graph_filename = f"simple_cnn_training_metrics_10_correcao_overfitting_e{num_epochs}.png"
