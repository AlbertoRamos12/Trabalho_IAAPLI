...
parser = argparse.ArgumentParser(description="Treinamento de uma CNN complexa no CIFAR-100.")
...
# ----------------------------
# DEFINIÇÃO DE UMA CNN MAIS COMPLEXA
# ----------------------------
...
model_filename = f"complex_cnn_100_e{num_epochs}.pth"
...
def plot_training_metrics(train_losses, train_accuracies, val_losses, val_accuracies, graphics_dir):
    ...
    graph_filename = f"complex_cnn_training_metrics_100_e{num_epochs}.png"
